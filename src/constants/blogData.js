...
export const blogData = {
  ...
  'modern-web-apps': {
    ...
    sections: [
      {
        heading: 'The Evolution of Web Development',
        content: `Modern web applications have come a long way from static HTML pages. 
  ...
  'js-tips': {
    ...
    sections: [
      {
        heading: 'Master JavaScript Like a Pro',
        content: `JavaScript is the backbone of modern web development, and mastering its 
